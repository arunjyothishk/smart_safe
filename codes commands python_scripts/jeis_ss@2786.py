...
password=["0010","7623","1122","8976","6452","0912","6104","8959","1324","8546"]
        ...
        while Tries:
            ...
            if but[0]=="$":
                ...
                while u<4:
                    push()
                    ps=""
                    print("but 0 value : "+str(but[0]))
                    print("ispressed value : "+str(bool(ispressed)))
                    if not but[0]=="NONE" and but[0]=="%":
                        u+=1
                        ps+=str(but[0] )
                        print (ps)
                        if ps==password[us]:
